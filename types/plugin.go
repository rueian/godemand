...
//go:generate mockgen -destination=mock/controller.go -package=$GOPACKAGE github.com/rueian/godemand/types Controller
...
//go:generate mockgen -destination=mock/launchpad.go -package=$GOPACKAGE github.com/rueian/godemand/types Launchpad
